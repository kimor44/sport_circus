...
class TroopsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create troop" do
    assert_difference('Troop.count') do
      post troops_url, params: { troop: { description: @troop.description, name: @troop.name, picture: @troop.picture, slug: @troop.slug } }
    end
  ...
  test "should update troop" do
    patch troop_url(@troop), params: { troop: { description: @troop.description, name: @troop.name, picture: @troop.picture, slug: @troop.slug } }
